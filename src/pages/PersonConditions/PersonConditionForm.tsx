...
export const PersonConditionForm = () => {
    ...
    return (
        <IonList className="ion-padding">
            ...
            <IonButton disabled={!ocupation.id || !profession.id || !economicActivity.id || !educationLevel || !maritalStatus || !econocmicDeps} onClick={onSubmit} expand="block" >Guardar</IonButton>
        </IonList>
    );
};
