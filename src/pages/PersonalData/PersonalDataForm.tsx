import { IonItem, IonInput, IonLabel, IonList, IonItemDivider, IonBadge, IonSelect, IonSelectOption, IonButton, useIonLoading } from "@ionic/react";
...
export const PersonalDataForm: React.FC<{ onSave: any }> = ( { onSave }) => {
  ...
  useEffect(() => {
    ...
    if (render) {
      render = false;
      showLoading({ message: "Cargando catalogos..."});
  ...
  return (
    <IonList className="ion-padding">
      ...
      {/* <ButtonSlider color='medium' expand="block" onClick={onSubmit} label={'Siguiente'} slideDirection='F' disabled={ nameError || lastnameError || !curpStatus ||!phoneStatus || !countryOfBirth || !nationality}  /> */}
            <IonButton color="success" expand="block" onClick={onSubmit}>Guardar</IonButton>
    </IonList>
